...
def main_trainer(QAC_data, model_dir):
    data_collator = DefaultDataCollator(return_tensors="tf")
    batch_size = 16
    num_epochs = 2

    tokenized_squad = create_data(QAC_data)

    total_train_steps = (
        len(tokenized_squad["train"]) // batch_size) * num_epochs
